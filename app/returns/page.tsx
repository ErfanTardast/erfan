...
export const metadata = {
  title: 'بازگشت و ضمانت کیفیت — Keyvan Rice',
  description: 'شرایط بازگشت کالا، ضمانت اصالت و روند رسیدگی به سفارش‌های کیوان.',
};
...
const RULES = [
  ...
  'در صورت اشتباه در ارسال یا آسیب‌دیدگی، هزینه بازگشت با کیوان است.',
