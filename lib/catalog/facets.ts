...
export const CATALOG_BRANDS = [
  ...
  },
  {
    kind: 'brand',
    slug: 'keyvan-organic',
    label: 'کیوان کشت طبیعی',
    englishLabel: 'Keyvan Natural Cultivation',
    description: 'محموله‌های محدود با رویکرد کشت طبیعی و توجه بیشتر به سلامت خاک.',
...
export const CATALOG_USE_CASES = [
  ...
  },
  {
    ...
    slug: 'organic-family',
    label: 'کشت طبیعی',
    englishLabel: 'Natural Cultivation',
    description: 'محموله‌های محدود با رویکرد کشت طبیعی برای مصرف خانوادگی.',
    shopHref: '/shop?organic=true',
    match: (product) => product.organic,
  },
  {
