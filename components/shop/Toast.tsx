    ...
    <AnimatePresence>
      {toast && toast.title && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 left-6 sm:left-auto z-[70] bg-ink text-white px-4 py-3.5 flex items-center gap-3 sm:min-w-[300px] sm:max-w-[380px] shadow-2xl"
        >
